...
function plexmeta(){
    ...
    cp ./config.yml /opt/appdata/plex-meta-manager/app/config.yml
    cp ./Movies.yml /opt/appdata/plex-meta-manager/app/Movies.yml
    cp ./TV.yml /opt/appdata/plex-meta-manager/app/TV.yml
